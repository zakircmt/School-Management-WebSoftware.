...
namespace SMStudent.Website.Admin.Controllers
{
    public class UserTypeTablesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,TypeName,Description,IsActive,EditDate")] UserTypeTable userTypeTable)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,TypeName,Description,IsActive,EditDate")] UserTypeTable userTypeTable)
        {
            if (ModelState.IsValid)
            {
