...
namespace SMStudent.Website.Users.Controllers
{
    public class PostOfficesController : Controller
    {
        ...
        public ActionResult Index(int? id)
        {
            ...
            return View(db.PostOffices.ToList());
        }
        ...
        public ActionResult Create(PostOffice postOffice)
        {
            var userid = 0;
            //var userTypeId = 0;
            int.TryParse(Convert.ToString(Session["SID"]), out userid);
            ...
            postOffice.EditDate = System.DateTime.Now;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(PostOffice postOffice)
        {
            var userid = 0;
            //var userTypeId = 0;
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            PostOffice postOffice = db.PostOffices.Find(id);
            db.PostOffices.Remove(postOffice);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
